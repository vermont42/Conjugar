...
enum Localizations {
  static var bothMasculine: String {
    NSLocalizedString("bothMasculineText", value: "Both", comment: "")
  }

  static var bothFeminine: String {
    NSLocalizedString("bothFeminineText", value: "Both", comment: "")
  }
