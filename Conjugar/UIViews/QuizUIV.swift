...
class QuizUIV: UIView {
  ...
  override init(frame: CGRect) {
    ...
    NSLayoutConstraint.activate([
      ...
      startRestartButton.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: Layout.defaultSpacing * -1.0),
      startRestartButton.centerXAnchor.constraint(equalTo: centerXAnchor),

      quitButton.centerYAnchor.constraint(equalTo: elapsedLabel.centerYAnchor),
      quitButton.trailingAnchor.constraint(equalTo: layoutMarginsGuide.trailingAnchor)
    ])
  }
